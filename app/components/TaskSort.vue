...
id="sort-by" v-model="sortBy"
        ...
        <div class="flex-1">
            <label for="sort-dir" class="block text-sm font-medium text-gray-700 mb-1">
                Sort Order
            </label>
            <button
type="button"
                ...
                :title="sortDir === 'asc' ? 'Ascending' : 'Descending'" @click="toggleSortDir">
